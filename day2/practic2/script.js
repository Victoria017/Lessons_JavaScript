...
let textResult= (yourNumber % 5 === 0) ? 'Кратне числу 5!' : 'Не кратне числу 5!';
alert(yourNumber + ' ' + textResult);
...
*/
(planet === 'земля' || planet==='Земля') ? alert('Привіт, землянине!') : alert('Привіт, інопланетянине!.');
